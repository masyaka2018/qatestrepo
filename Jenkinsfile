node {
   ...
   stage('PBA'){
       cloudBeesFlowTriggerRelease configuration: 'flow-server', parameters: '{"release":{"releaseName":"qe release","stages":[{"stageName":"Stage 1","stageValue":""}],"pipelineName":"qe pipeline","parameters":[]}}', projectName: 'qe proj 1', releaseName: 'qe release', startingStage: ''
   }
